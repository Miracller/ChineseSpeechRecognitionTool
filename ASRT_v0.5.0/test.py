...
r = ms.RecognizeSpeech_FromFile('E:\语音数据集\ST-CMDS-20170001_1-OS\\20170001P00136I0086.wav')
...
#r = ms.RecognizeSpeech_FromFile('E:\\语音数据集\\wav\\test\\test\\01.wav')
#r = ms.RecognizeSpeech_FromFile('E:\\Git\\gitres\\ASRT_v0.5.0\\01.wav')
print('*[提示] 语音识别结果：\n',r)
